			...
			<div class="card">
				@foreach($akun as $acc)
						...
						<div>
						    ...
						    <div class="input-group mb-2">
						        <div class="input-group-prepend">
						          	...
						          	<p style="border: 1px solid grey; border-radius: 0 50px 50px 0; width: 400px; padding-top: 8px; padding-bottom: 8px; padding-left: 7px;">					          	
	                                    <a href="/listAgent/download/{{ $acc->id }}">
	                                        Download File CV Agent
	                                    </a>
	                                </p>
						        </div>
						    </div>
					...
					<div class="card-footer text-muted">
						<a href="{{ url('/user/edit/' .Session::get('id')) }}">
